...
export class ConfirmWalletModal {
  ...
  // Перехватить код из консоли. Порядок важен: сначала подписываемся на консоль,
  // только потом жмем кнопку — иначе сообщение может проскочить.
  // Клик "Добавить счет" передаем сюда как triggerAction.
